...
public class ForgetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        res.setOnClickListener(v -> {
            if(!isValidEmail(fe.getText().toString().trim())){
                fe.setError("Please enter a valid email address !");
            }else {
                firebaseAuth.sendPasswordResetEmail(fe.getText().toString().trim()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
